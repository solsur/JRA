...
/**
 * Created by NT on 4/10/2016.
 */
public class AccessServiceAPI {

    /**
     * Call service api with GET method and then return result from service as json string
     * @param url
     * @return
     */
     ...
     * @return
     */
    public static JSONArray convertJSONString2Array(String jsonString) {
        JSONArray jsonArray = null;
        try {
